...
public class PageNumberMaker2 {
	
	private PaginationCriteria2 criteria;
	// 게시글 전체 갯수
	...
	public PageNumberMaker2() {
		this.numsOfLinks = 10;
	}

	public PaginationCriteria2 getCriteria() {
		return criteria;
	}

	public void setCriteria(PaginationCriteria2 criteria) {
